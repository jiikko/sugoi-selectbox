    ...
    DropDown = createClass({
        ...
        methods: {
            open: function () {
                ...
                $(document).on("mousedown.dropdown", $.proxy(function (e) {
                    var inside = false, container = this.container.get(0);
    ...
    Select2 = createClass({
        ...
        methods: {
            init: function () {
                ...
                this.el.on("opened", $.proxy(function() {
                    this.results.open();
                }, this));
